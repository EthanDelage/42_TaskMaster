...
ProcessPool::ProcessPool(
    std::unordered_map<std::string, process_config_t> &&config_map) {
...
ProcessPool::PoolIterator ProcessPool::begin() { return _process_pool.begin(); }
...
ProcessPool::PoolIterator ProcessPool::end() { return _process_pool.end(); }
